...
import { createTask, getAllEmployees } from "../../api/employeeApi";
...
const Tasks = () => {
  ...
  }, [search, selectedEmployee, fetchEmployees]);
  ...
  const handleEmployeeSelect = (employee) => {
    ...
    console.log("Passing user_id as assigned_to:", employee.user_id);
    ...
    setSearch(`${employee.name || ""} - ${employee.employee_id || ""}`);
  ...
  const validateForm = () => {
    ...
    if (!formData.assigned_to) {
      newErrors.assigned_to = "Please search and select an employee.";
    }
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      console.log("Task request payload:", payload);
  ...
  return (
    <div className="min-h-full bg-gray-50 p-6">
      {/* Page heading */}
      <div className="mb-6">
        <h1 className="text-2xl font-semibold text-ettm-blue">Assign Task</h1>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-6 rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
          ...
          {errors.assigned_to && (
            <p className="mt-2 text-xs text-red-500">{errors.assigned_to}</p>
          )}
            ...
            <div className="mt-5 rounded-xl border border-ettm-blue/20 bg-blue-50/50 p-5">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    This employee will receive the task.
                  </p>
                </div>
