...
export const getAllEmployees = async ({ page = 1, search = "" } = {}) => {
  const params = {
    page,
  };
  ...
  const response = await axiosInstance.get("api/v1/employees/profiles/", {
    params,
  });
...
export const getAllTasks = async ({
  ...
  const response = await axiosInstance.get("api/v1/tasks/admin/manage/", {
    params,
  });
...
// Attendance History
export const getAttendanceHistory = async ({ page = 1, date = "" } = {}) => {
  const params = {
    page,
  };
  ...
  const response = await axiosInstance.get("api/v1/attendance/admin/history/", {
    params,
  });
...
export const getAttendanceByDate = async (date) => {
  ...
  const endpointVariants = [
    {
      url: "api/v1/attendance/employee/history/",
...
export const getMyTasks = async (page = 1) => {
  const response = await axiosInstance.get("api/v1/tasks/employee/my-tasks/", {
    params: {
      page,
    },
  });
